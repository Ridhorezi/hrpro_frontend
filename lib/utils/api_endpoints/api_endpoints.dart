class ApiEndpoints {
  ...
  static const String getAllTodo = 'api/todo/all-todos';
  static const String addTodoUrl = 'api/todo/add-todo';
  static const String deleteTodo = 'api/todo/delete';
  static const String updateStatus = 'api/todo/update-status';
}
